---
title: "Walmart Return Policy"
company: "Walmart"
vendorSlug: "walmart"
policyType: "Return Policy"
category: "return-policies"

sourceUrl: "https://corporate.walmart.com/policies#return-policy"
sourceUrlsAdditional: []
sourceFiles:
  - "sources/walmart/walmart_returns_2026.05.10.txt"
...
summary: "Most items can be returned within 90 days to a Walmart store, by mail, or by FedEx drop-off. Refunds go back to the original payment method. Major appliances have a 2-day window, electronics get 30 days, and a long list of items can't be returned at all."
...
watchOutFor:
  - headline: "Major appliances get 2 days, and only if you didn't accept delivery damaged."
    detail: "Refrigerators, ranges, washers, dryers, dishwashers, and similar large appliances are returnable for a full refund only within 2 days of accepted delivery. After that, the manufacturer's warranty is the only path, even for damage you didn't catch right away. Unopened, factory-sealed units get 30 days but can carry up to a 20% restocking fee. Major appliances cannot be returned in stores — pickup is arranged through walmart.com."
  - headline: "A long list of items is final sale, with no returns or refunds at all."
    detail: "Includes alcohol, tobacco, firearms, ammunition, prescription medication, gift cards, prepaid cards, opened software downloads, opened trading cards, hygienic medical equipment, ovulation/pregnancy tests, COVID and other home test kits, used or mounted tires, gas-powered recreational vehicles, and special orders. Some marketplace collectibles are final sale even when the same item from Walmart wouldn't be."
  - headline: "Marketplace items follow the seller's policy, with up to a 20% restocking fee."
    detail: "Items shipped by Marketplace sellers are returnable to the seller, not Walmart, under whatever return policy the seller posts. Marketplace returns of major appliances, collectibles, and luxury items may be subject to up to a 20% restocking fee. Some Marketplace items can't be returned to a Walmart store at all."
...
| Payment method | Refund destination (with receipt) | Timing |
|---|---|---|
| Cash or check | Cash | Immediate |
| Credit card | Same credit card or Walmart Gift Card | Up to 10 business days |
| Debit card with PIN | Same debit card, Walmart Gift Card, or cash | Up to 7 business days |
| Walmart Gift Card | Walmart Gift Card | Up to 3 hours |
| EBT Card | EBT Card | Up to 3 hours |
| EBT Cash | Cash or Walmart Gift Card | Immediate |
| Walmart Cash | Walmart Cash balance | Up to 3 hours |
| Walmart Balance | Walmart Balance | Up to 3 hours |
