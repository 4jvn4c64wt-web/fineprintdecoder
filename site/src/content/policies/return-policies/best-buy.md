---
title: "Best Buy Return Policy"
company: "Best Buy"
vendorSlug: "best-buy"
policyType: "Return Policy"
category: "return-policies"

sourceUrl: "https://www.bestbuy.com/site/help-topics/return-exchange-policy/pcmcat260800050014.c?id=pcmcat260800050014"
sourceUrlsAdditional: []
sourceFiles:
  - "sources/best-buy/best-buy_returns-and-exchanges_2026.05.10.txt"
...
summary: "Standard members get 15 days on most items; My Best Buy Plus and Total members get 60. Phones and tablets are 14 days for everyone. Some items carry a restocking fee; trading cards, prepaid cards, and opened bodily-contact products can't be returned at all."
...
channels:
  - label: "Online"
    ...
    howTo:
      ...
      - "Pack the item with its original contents and packaging. Attach the label."
      - "Drop the package at an authorized carrier location and ship it within your return window."
      - "Best Buy issues the refund to your original payment method once the return is received and inspected."
  ...
  - label: "In-store"
    ...
    howTo:
      ...
      - "Go to the Customer Service desk at any Best Buy store within your return window."
      - "Best Buy inspects the item and processes the refund or exchange. Refund goes to the original payment method."

watchOutFor:
  - headline: "Phones carry a $45 restocking fee even if you've barely used them."
    detail: "Any activatable device (cell phone, cellular tablet, mobile hotspot, cellular wearable) returned within the 14-day window is subject to a $45 restocking fee — unless the item is unopened, or the purchase happened in an exempt state (AL, CO, HI, IA, MS, OH, OK, SC)."
  - headline: "Trading cards and Pokémon cards can't be returned, period."
    detail: "Best Buy lists trading cards explicitly in its non-returnable items. This applies regardless of condition, membership tier, or whether the item is opened."
  - headline: "Some items can't come back once opened."
    detail: "Products that interact with bodily fluids, SIM kits, LEGO products, and certain Marketplace entertainment products (physical software, movies, music, video games, books) are non-returnable once opened. Check before opening."
  - headline: "If you bought from a Marketplace Seller on BestBuy.com, it may not be returnable in-store."
    detail: "Size and product limitations may prevent a store from accepting a Marketplace return in-store, and stores in Puerto Rico and Pacific Sales locations don't accept them at all. When in doubt, use the prepaid label method."
