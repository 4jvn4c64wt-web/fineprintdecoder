...
sourceFiles:
  - "sources/amazon/return-policy_2026-05-10.txt"
...
watchOutFor:
  - headline: "\"Final Sale\" items can't be returned at all."
    detail: "This covers trading card games, certain discounted items, and any Amazon Haul item priced $3 or less. The product page flags these. Check before buying."
  - headline: "Late returns are charged a fee."
    detail: "Drop off within 30 days past the return-by date listed in your order: 20% of the item price. After that: 100%, which leaves no refund."
  - headline: "Opened software, video games, and collectible cards have a 100% restocking fee."
    detail: "Once these are opened, activated, or used, the restocking fee equals the full item price. Functionally non-returnable."
  - headline: "Damaged returns can be charged up to 50% of the item price."
    detail: "Tags removed, missing parts, or visible signs of use that aren't Amazon's fault all qualify. Amazon Luxury items can be charged 100%."
